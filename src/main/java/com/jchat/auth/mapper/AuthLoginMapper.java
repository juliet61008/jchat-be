...
import com.jchat.auth.dto.PasswordByIdReqDto;
import com.jchat.auth.dto.PasswordByIdResDto;
...
public interface AuthLoginMapper {
    ...
    PasswordByIdResDto searchPasswordById(PasswordByIdReqDto passwordByIdReqDto);
}